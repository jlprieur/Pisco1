/******************************************************************************
* Name:        psc1_language (PscFrame class)
...
#include "psc1_language.h"  // Unicode/html conversion array
...
/************************************************************************
* Load Messages contained in Pisco1_messages.txt and
* save them to private array Str0
* iLang: 0=English 1=French 2=Italian 3=Spanish 4=German
*************************************************************************/
int PscFrame::LoadMenuMessages()
{
int status;
char fname[128];
wxString buffer;

strcpy(fname, "Pisco1_messages.txt");
...
if((fp_in = fopen(in_fname, "r")) == NULL) {
  fprintf(stderr, "read_messages_file/Fatal error opening input file >%s<\n",
          in_fname);
  return(-1);
  }
